...
const AddLicensee = ({ status, message }) => {
    ...
    const addRow = (identifier) => {
        setFormData(prevState => {
            ...
            switch (identifier) {
                case 'pbwd_id':
                    newRow.number_of_bore_well = ""; newRow.gps_location_pb = "";
                    return { ...prevState, pbwd_row: [...prevState.pbwd_row, newRow] };
                case 'pgwd_id':
                    newRow.sizeofborep = ""; newRow.volumestoragep = ""; newRow.gps_location_pg = "";
                    return { ...prevState, pgwd_row: [...prevState.pgwd_row, newRow] };
                case 'dm_id':
                    newRow.number_of_pumps = ""; newRow.ro_plant = ""; newRow.pump_make = "";
                    newRow.power_of_motor = ""; newRow.discharge_gpm = ""; newRow.gps_location_md = "";
                    return { ...prevState, dm_row: [...prevState.dm_row, newRow] };
                case 'dcb_id':
                    newRow.number_of_bores = ""; newRow.size_of_pipe = ""; newRow.depth_volume_storage = "";
                    newRow.discharge_per_month = ""; newRow.gps_location_cb = "";
                    return { ...prevState, dcb_row: [...prevState.dcb_row, newRow] };
                case 'dc_id':
                    newRow.consumer_name = ""; newRow.quantum_supplied = ""; newRow.gps_location_cd = "";
                    return { ...prevState, dc_row: [...prevState.dc_row, newRow] };
                case 'dwss_id':
                    newRow.source_of_water = ""; newRow.existing_number_and_size = ""; newRow.Volume_in_gallon = "";
                    return { ...prevState, dwss_row: [...prevState.dwss_row, newRow] };
                case 'iqgwb_id':
                    newRow.consumer_name = ""; newRow.quantum_supplied = ""; newRow.gps_location_cd = "";
                    return { ...prevState, iqgwb_row: [...prevState.iqgwb_row, newRow] };
                case 'dpfm_id':
                    newRow.made = ""; newRow.type = ""; newRow.size = "";
                    return { ...prevState, dpfm_row: [...prevState.dpfm_row, newRow] };
                default:
                    newRow.sizeofboreap = ""; newRow.volumestorageap = ""; newRow.gps_location_ap = "";
    ...
    const handleRowChange = (e, index, field) => {
        ...
        setFormData(prevState => {
            ...
            return { ...prevState, agwd_row: updatedApgw, pbwd_row: updatedPbwd, pgwd_row: updatedPgwd, dcb_row: updatedBcd, dm_row: updatedBm, dc_row: updatedDc, dwss_row: updatedDwss, iqgwb_row: updatedIqwb, dpfm_row: updatedDpfm };
        });
    };
    ...
    const addDocument = () => {
        setFormData(prevState => ({
            ...
            customer_documents: [
                ...
                { id: prevState.customer_documents.length + 1, document_type: '', image_path: null }
            ],
        }));
    };
    ...
    return (
        <form className="max-w-5xl mx-auto p-6 border my-6 bg-white shadow-md rounded-lg" onSubmit={handleSubmit} encType="multipart/form-data">
                    ...
                    <div className={styles.container}>
                        <div className={styles.row}>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                <label htmlFor="pre_company_name" className="block text-sm font-medium mb-2">Name Of Company:</label>
                                <input
                                    type="text"
                                    id="pre_company_name"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                <label htmlFor="licensee_name" className="block text-sm font-medium mb-2">Licensee Name:</label>
                                <input
                                    type="text"
                                    id="licensee_name"
                                    name="licensee_name"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <label htmlFor="contact_number" className="block text-sm font-medium mb-2">Contact Number:</label>
                            <input
                                type="text"
                                id="contact_number"
                                name="contact_number"
                        ...
                        <div className={styles.tableSection}>
                            ...
                            <h3 className={styles.subHeading}>Previous Bores/Wells/Tube Wells Details</h3>
                            {formData.pbwd_row.map((pbwd, index) => (
                                <div key={`${pbwd.id}-${index}`} className={styles.row}>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                        <label className={styles.label1}>Number of Bores</label>
                                        <input type="text" className="w-full p-2 border rounded focus:outline-none focus:ring focus:ring-blue-300" value={pbwd.number_of_bore_well} onChange={(e) => handleRowChange(e, index, 'number_of_bore_well')} />
                                    </div>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                        <label className={styles.label1}>GPS Location</label>
                                        <input type="text" className="w-full p-2 border rounded focus:outline-none focus:ring focus:ring-blue-300" value={pbwd.gps_location_pb} onChange={(e) => handleRowChange(e, index, 'gps_location_pb')} />
                                    </div>
                                </div>
                            ...
                            <button
                                type="button"
                                onClick={() => addRow(identifier = "pbwd_id", { gps_location_pg: "", number_of_bore_well: "" })}
                                className={styles.addButton}
                            >
                                <MdAddCircleOutline /> Add More
                            </button>
                            <h3 className={styles.subHeading}>Previous Ground Water Network Details</h3>
                            {formData.pgwd_row.map((pgwnd, index) => (
                                <div key={`${pgwnd.id}-${index}`} className={styles.row}>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => handleRowChange(e, index, 'volumestoragep')}
                                        />
                                    </div>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                        <label className={styles.label1}>GPS Location</label>
                                        <input
                                            ...
                                            onChange={(e) => handleRowChange(e, index, 'gps_location_pg')}
                                        />
                                    </div>
                                </div>
                            ))}
                            ...
                            <button
                                type="button"
                                onClick={() => addRow(identifier = "pgwd_id", { sizeofborep: "", volumestoragep: "", gps_location_pg: "" })}
                                className={styles.addButton}
                            >
                                <MdAddCircleOutline /> Add More
                            </button>
            ...
            <div className={styles.tableSection}>
                <h3 className={styles.subHeading}>Applied Ground Water Network Details</h3>
                ...
                <button
                    type="button"
                    onClick={() => addRow({ sizeofboreap: "", volumestorageap: "", gps_location_ap: "" })}
                    className={styles.addButton}
                >
                    <MdAddCircleOutline /> Add More
                </button>
                ...
                {formData.dcb_row.map((dcb, index) => (
                    <div key={`${dcb.id}-${index}`} className={styles.row}>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <label className={styles.label1}>Number of Bores</label>
                            <input type="text" className="w-full p-2 border rounded focus:outline-none focus:ring focus:ring-blue-300" value={dcb.number_of_bores} onChange={(e) => handleRowChange(e, index, 'number_of_bores')} />
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <label className={styles.label1}>Size of Pipe</label>
                            <input type="text" className="w-full p-2 border rounded focus:outline-none focus:ring focus:ring-blue-300" value={dcb.size_of_pipe} onChange={(e) => handleRowChange(e, index, 'size_of_pipe')} />
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <label className={styles.label1}>Depth/Volume of Storage</label>
                            <input type="text" className="w-full p-2 border rounded focus:outline-none focus:ring focus:ring-blue-300" value={dcb.depth_volume_storage} onChange={(e) => handleRowChange(e, index, 'depth_volume_storage')} />
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <label className={styles.label1}>Discharge of Bore per Month</label>
                            <input type="text" className="w-full p-2 border rounded focus:outline-none focus:ring focus:ring-blue-300" value={dcb.discharge_per_month} onChange={(e) => handleRowChange(e, index, 'discharge_per_month')} />
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <label className={styles.label1}>GPS Location</label>
                            <input type="text" className="w-full p-2 border rounded focus:outline-none focus:ring focus:ring-blue-300" value={dcb.gps_location_cb} onChange={(e) => handleRowChange(e, index, 'gps_location_cb')} />
                        </div>
                    </div>
                ))}
                <button type="button" onClick={() => addRow(identifier = "dcb_id", { number_of_bores: "", size_of_pipe: "", depth_volume_storage: "", discharge_per_month: "", gps_location_cb: "" })} className={styles.addButton}><MdAddCircleOutline /> Add More</button>
                ...
                {formData.dm_row.map((dmp, index) => (
                    <div key={`${dmp.id}-${index}`} className={styles.row}>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            ...
                            <input type="text" className="w-full p-2 border rounded focus:outline-none focus:ring focus:ring-blue-300" value={dmp.number_of_pumps} onChange={(e) => handleRowChange(e, index, 'number_of_pumps')} />
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <label className={styles.label1}>R/O Plant</label>
                            <input type="text" className="w-full p-2 border rounded focus:outline-none focus:ring focus:ring-blue-300" value={dmp.ro_plant} onChange={(e) => handleRowChange(e, index, 'ro_plant')} />
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <label className={styles.label1}>Pump Make / Type</label>
                            <input type="text" className="w-full p-2 border rounded focus:outline-none focus:ring focus:ring-blue-300" value={dmp.pump_make} onChange={(e) => handleRowChange(e, index, 'pump_make')} />
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <label className={styles.label1}>Power of Motor in HP</label>
                            <input type="text" className="w-full p-2 border rounded focus:outline-none focus:ring focus:ring-blue-300" value={dmp.power_of_motor} onChange={(e) => handleRowChange(e, index, 'power_of_motor')} />
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <label className={styles.label1}>Discharge in GPM</label>
                            <input type="text" className="w-full p-2 border rounded focus:outline-none focus:ring focus:ring-blue-300" value={dmp.discharge_gpm} onChange={(e) => handleRowChange(e, index, 'discharge_gpm')} />
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <label className={styles.label1}>GPS Location</label>
                            <input type="text" className="w-full p-2 border rounded focus:outline-none focus:ring focus:ring-blue-300" value={dmp.gps_location_md} onChange={(e) => handleRowChange(e, index, 'gps_location_md')} />
                        </div>
                    </div>
                ))}
                <button type="button" onClick={() => addRow(identifier = "dm_id", { number_of_pumps: "", ro_plant: "", pump_make: "", power_of_motor: "", discharge_gpm: "", gps_location_md: "" })} className={styles.addButton}><MdAddCircleOutline /> Add More</button>
                ...
                {formData.dc_row.map((doc, index) => (
                    <div key={`${doc.id}-${index}`} className={styles.row}>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            ...
                            <input type="text" className="w-full p-2 border rounded focus:outline-none focus:ring focus:ring-blue-300" value={doc.consumer_name} onChange={(e) => handleRowChange(e, index, 'consumer_name')} />
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <label className={styles.label1}>Quantum Supplied</label>
                            <input type="text" className="w-full p-2 border rounded focus:outline-none focus:ring focus:ring-blue-300" value={doc.quantum_supplied} onChange={(e) => handleRowChange(e, index, 'quantum_supplied')} />
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <label className={styles.label1}>GPS Location</label>
                            <input type="text" className="w-full p-2 border rounded focus:outline-none focus:ring focus:ring-blue-300" value={doc.gps_location_cd} onChange={(e) => handleRowChange(e, index, 'gps_location_cd')} />
                        </div>
                    </div>
                ))}
                <button type="button" onClick={() => addRow(identifier = "dc_id", { consumer_name: "", quantum_supplied: "", gps_location_cd: "" })} className={styles.addButton}><MdAddCircleOutline /> Add More</button>
                ...
                {formData.dwss_row.map((dwss, index) => (
                    <div key={`${dwss.id}-${index}`} className={styles.row}>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            ...
                            <input type="text" className="w-full p-2 border rounded focus:outline-none focus:ring focus:ring-blue-300" value={dwss.source_of_water} onChange={(e) => handleRowChange(e, index, 'source_of_water')} />
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <label className={styles.label1}>Existing Number and Size of Water Connection</label>
                            <input type="text" className="w-full p-2 border rounded focus:outline-none focus:ring focus:ring-blue-300" value={dwss.existing_number_and_size} onChange={(e) => handleRowChange(e, index, 'existing_number_and_size')} />
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <label className={styles.label1}>Volume in Gallon per Month</label>
                            <input type="text" className="w-full p-2 border rounded focus:outline-none focus:ring focus:ring-blue-300" value={dwss.Volume_in_gallon} onChange={(e) => handleRowChange(e, index, 'Volume_in_gallon')} />
                        </div>
                    </div>
                ))}
                <button type="button" onClick={() => addRow(identifier = "dwss_id", { source_of_water: "", existing_number_and_size: "", Volume_in_gallon: "" })} className={styles.addButton}><MdAddCircleOutline /> Add More</button>

                <h3 className={styles.subHeading}>Intended Quantity of Ground Water Extraction From Bores</h3>
                {formData.iqgwb_row.map((iqgwb, index) => (
                    <div key={`${iqgwb.id}-${index}`} className={styles.row}>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            ...
                            <input type="text" className="w-full p-2 border rounded focus:outline-none focus:ring focus:ring-blue-300" value={iqgwb.bore} onChange={(e) => handleRowChange(e, index, 'bore')} />
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <label className={styles.label1}>Dischare From Each Bores</label>
                            <input type="text" className="w-full p-2 border rounded focus:outline-none focus:ring focus:ring-blue-300" value={iqgwb.discharge_from_well} onChange={(e) => handleRowChange(e, index, 'discharge_from_well')} />
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <label className={styles.label1}>TDS Value</label>
                            <input type="text" className="w-full p-2 border rounded focus:outline-none focus:ring focus:ring-blue-300" value={iqgwb.tds_value_ppm} onChange={(e) => handleRowChange(e, index, 'tds_value_ppm')} />
                        </div>
                    </div>
                ))}
                <button type="button" onClick={() => addRow(identifier = "iqgwb_id", { bore: "", discharge_from_well: "", tds_value_ppm: "" })} className={styles.addButton}><MdAddCircleOutline /> Add More</button>
                ...
                {formData.dpfm_row.map((dpfm, index) => (
                    <div key={`${dpfm.id}-${index}`} className={styles.row}>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            ...
                            <input type="text" className="w-full p-2 border rounded focus:outline-none focus:ring focus:ring-blue-300" value={dpfm.made} onChange={(e) => handleRowChange(e, index, 'made')} />
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <label className={styles.label1}>Type</label>
                            <input type="text" className="w-full p-2 border rounded focus:outline-none focus:ring focus:ring-blue-300" value={dpfm.type} onChange={(e) => handleRowChange(e, index, 'type')} />
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <label className={styles.label1}>Size</label>
                            <input type="text" className="w-full p-2 border rounded focus:outline-none focus:ring focus:ring-blue-300" value={dpfm.size} onChange={(e) => handleRowChange(e, index, 'size')} />
                        </div>
                    </div>
                ))}
                <button type="button" onClick={() => addRow(identifier = "dpfm_id", { made: "", type: "", size: "" })} className={styles.addButton}><MdAddCircleOutline /> Add More</button>
            </div>
            ...
            {formData.customer_documents.map((docs, index) => (
                <div key={docs.id} className={styles.row}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        <label htmlFor={`document_type-${index}`} className="block text-sm font-medium mb-2">Document Type:</label>
                        <select
                        ...
                        >
                            ...
                            <option value="NOC from concerned industrial Association">NOC from concerned industrial Association</option>
                            <option value="written Request to CEO kW&SB for Category (C, D & E)">written Request to CEO kW&SB for Category (C, D & E)</option>
                            <option value="No Objection Certificate of Land Owing Agency">No Objection Certificate of Land Owing Agency</option>
                            <option value="Hydrological Study & Test Report">Hydrological Study & Test Report</option>
                            <option value="Detail List of Consumer">Detail List of Consumer</option>
                            <option value="Sanction Order">Sanction Order</option>
                            <option value="Undertaking on Judicial Stamp Paper">Undertaking on Judicial Stamp Paper</option>
                            <option value="Pay Order">Pay Order</option>
                        </select>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        <label htmlFor={`image_path-${index}`} className="block text-sm font-medium mb-2">Upload Document Image:</label>
                        <input
                            type="file"
                            id={`image_path-${index}`}
                            name="image_path"
